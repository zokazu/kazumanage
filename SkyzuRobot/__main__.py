...
buttons = [
    ...
    [
        InlineKeyboardButton(
            text="sᴏᴜʀᴄᴇ ᴄᴏᴅᴇ​", url="https://github.com/zokazu/kazumanage"
        ),
...
EMI_IMG = "https://telegra.ph/file/6cae9aa5e2065b92f58a3.jpg"
...
def Skyzu_about_callback(update, context):
    ...
    if query.data == "kazu_":
        query.message.edit_text(
            text="๏ I'm *kazu*, a powerful group management bot built to help you manage your group easily."
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton(
                            text="ᴀᴅᴍɪɴs​", callback_data="kazu_admin"
                        ),
                        InlineKeyboardButton(
                            text="ɴᴏᴛᴇs​", callback_data="kazu_notes"
                        ),
                    ],
                    [
                        InlineKeyboardButton(
                            text="sᴜᴘᴘᴏʀᴛ​", callback_data="kazu_support"
                        ),
                        InlineKeyboardButton(
                            text="ᴄʀᴇᴅɪᴛs​", callback_data="kazu_credit"
                        ),
                    ],
                    [
                        InlineKeyboardButton(
        ...
        query.message.edit_text(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton(text="sᴜᴘᴘᴏʀᴛ​", url="t.me/kazusupport"),
                        InlineKeyboardButton(
                            text="ᴜᴘᴅᴀᴛᴇs​", url="https://t.me/kazuprojects"
                        ),
                    ],
                    [
                        InlineKeyboardButton(text="ɢᴏ ʙᴀᴄᴋ​", callback_data="kazu_"),
        ...
        query.message.edit_text(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton(text="kazu", url="t.me/kazuprojects"),
                    ],
                    [
                        InlineKeyboardButton(text="ɢᴏ ʙᴀᴄᴋ​", callback_data="kazu_"),
                    ],
